...
export default function Footer() {
  return (
    <footer className="footerContainer w-full h-[300px] flex bg-footerColor justify-around pb-[40px] pt-[10px] items-center ">
      <div className="footerNav text-2xl text-[#454545] pt-[20px]">
      ...
      <div className="newsletterContainer flex flex-col gap-[10px]">
        <h1 className="text-[40px]">Join out Newsletter!</h1>
        <p className="text-[15px] text-[#E63F97] pb-[8px]">
        ...
        <div className="inputContainer">
          <form className="inputContainer">
            <input
              ...
              className="footerInput text-[22px] py-[14px] px-[14px] rounded-lg w-[21.5rem] text-[#747474] focus:outline-none"
            />
            <button
              type="submit"
              className="footerButton text-[20px] py-[16px] px-[7px] bg-[#E63F97] hover:bg-opacity-75 transition duration-300 ease-in-out rounded-lg w-28 text-white"
            >
              Subscribe
            </button>
          </form>

...
export default function MenuItem({ name, description, image }: MenuItemProps) {
  ...
  const plusSignClass = ` cursor-pointer absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white text-[10em] font-['Varela Round'] opacity-0 transition-opacity duration-500 ease-in-out ${
  ...
  return (
    ...
    >
      <img src={image} alt={name} className="mb-2 rounded-t-[10px] cursor-pointer" />
